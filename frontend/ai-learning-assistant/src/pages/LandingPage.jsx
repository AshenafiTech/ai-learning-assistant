  ...
  const steps = [
    {
      ...
      description: 'Simply upload your PDF documents to get started. Our AI will process them instantly.',
      icon: Upload,
      color: 'indigo'
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50/50 via-white to-purple-50/50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-slate-900">Quick Study</span>
            </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100/50 rounded-full mb-8">
          ...
          <p className="text-xl md:text-2xl text-indigo-600/80 mb-10 leading-relaxed max-w-2xl mx-auto">
            Transform your PDFs into interactive study materials with AI-powered flashcards, quizzes, and explanations.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/register"
              className="group px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/40 flex items-center gap-2"
            >
              Start Learning Free
            ...
            <Link
              to="/login"
              className="px-8 py-4 border-2 border-indigo-200 text-indigo-700 hover:bg-indigo-50 text-lg font-semibold rounded-xl transition-all duration-200"
            >
              Sign In
            </Link>
          </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-indigo-600/70 max-w-2xl mx-auto">
            Powerful AI tools designed to make learning more efficient and enjoyable
          </p>
        </div>
            ...
            return (
              <div key={index} className="relative">
                <div className="bg-white/90 backdrop-blur-xl border border-indigo-100/60 rounded-2xl p-8 text-center">
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${colorClasses[step.color]} mb-6 shadow-lg`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3">
                  <CheckCircle2 className="w-6 h-6 text-cyan-300 shrink-0" strokeWidth={2.5} />
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        <div className="bg-white/90 backdrop-blur-xl border-2 border-indigo-200 rounded-3xl p-12 md:p-16 text-center">
          ...
          <p className="text-xl text-indigo-600/70 mb-10 max-w-2xl mx-auto">
            Join Quick Study today and experience the future of learning
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/register"
              className="group px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-indigo-500/30 hover:shadow-xl flex items-center gap-2"
            >
              Start Free Trial
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" strokeWidth={2.5} />
            </Link>
      ...
      <footer className="relative z-10 border-t border-indigo-100/60 bg-white/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="mt-8 pt-8 border-t border-indigo-100/60 text-center text-sm text-indigo-600/70">
            <p>© 2024 Quick Study. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
