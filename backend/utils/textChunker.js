/**
 * Split text into word-based chunks with optional overlap, preserving paragraph boundaries.
...
export const chunkText = (text, chunkSize = 500, overlap = 50) => {
    ...
    for (const paragraph of paragraphs) {
        ...
        // If paragraph itself exceeds chunk size, split it by words
        ...
        if (currentWordCount + paragraphWordCount > chunkSize && currentChunk.length > 0) {
            ...
            const overlapWords = prevChunkWords.slice(-Math.min(overlap, prevChunkWords.length));
...
/** 
 * Find relevant chunks based on a simple keyword matching approach.
...
export const findRelevantChunks = (chunks, query, maxChunks = 3) => {
    ...
    const stopWords = new Set([
        ...
        'must', 'ought', 'i', 'you', 'he', 'she', 'it', 'we', 'they', 'them', 'their', 
        'this', 'that', 'these', 'those'
    ]);

    // Extract keywords from query words
